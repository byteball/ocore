...
function createAndSend(hash, peer_address, peer_device_address, my_address, creation_date, ttl, text, cb) {
	var status = 'active';
	db.query("INSERT INTO prosaic_contracts ('hash', 'peer_address', 'peer_device_address', 'my_address', 'is_incoming', 'creation_date', 'ttl', 'status', 'text') VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", [hash, peer_address, peer_device_address, my_address, false, creation_date, ttl, status, text], function() {
