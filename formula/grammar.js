...
var grammar = {
    ...
    {"name": "N", "symbols": [{"literal":"ceil"}, (lexer.has("l") ? {type: "l"} : l), "AS", "N$ebnf$3", (lexer.has("r") ? {type: "r"} : r)], "postprocess": function(d) {return ['ceil', d[2], d[3] ? d[3][1] : null]; }},
    {"name": "N$ebnf$4$subexpression$1", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), "AS"]},
    {"name": "N$ebnf$4", "symbols": ["N$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "N$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "N", "symbols": [{"literal":"floor"}, (lexer.has("l") ? {type: "l"} : l), "AS", "N$ebnf$4", (lexer.has("r") ? {type: "r"} : r)], "postprocess": function(d) {return ['floor', d[2], d[3] ? d[3][1] : null]; }},
    {"name": "N$ebnf$5$subexpression$1", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), "AS"]},
    {"name": "N$ebnf$5", "symbols": ["N$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "N$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "N", "symbols": [{"literal":"round"}, (lexer.has("l") ? {type: "l"} : l), "AS", "N$ebnf$5", (lexer.has("r") ? {type: "r"} : r)], "postprocess": function(d) {return ['round', d[2], d[3] ? d[3][1] : null]; }},
