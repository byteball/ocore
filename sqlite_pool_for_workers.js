...
module.exports = function(db_name, MAX_CONNECTIONS, bReadOnly, customPath){
	if (customPath) {
		path = customPath;
	}
	...
	createDatabaseIfNecessary(path, db_name, onDbReady);
...
function createDatabaseIfNecessary(path, db_name, onDbReady){
